...
try:
    from sdks.python.nietzsche_legacy import NietzscheBaseClient
    from sdks.python.nietzsche_legacy.client import Durability
except ImportError:
    print("⚠️  NietzscheDB SDK not found in path. Trying pip installed package...")
