...
use dashmap::DashMap;
use nietzsche_core::{Collection, CosineMetric, EuclideanMetric, LorentzMetric, PoincareMetric};
...
impl CollectionManager {
    ...
    async fn create_collection_internal(
        ...
        let quantization = std::env::var("NDB_QUANTIZATION_LEVEL")
...
impl CollectionMetadata {
    ...
    fn quantization_mode(&self) -> nietzsche_core::QuantizationMode {
        match self.quantization.as_str() {
            "binary" => nietzsche_core::QuantizationMode::Binary,
            "none" => nietzsche_core::QuantizationMode::None,
            _ => nietzsche_core::QuantizationMode::ScalarI8,
        }
    }
}
