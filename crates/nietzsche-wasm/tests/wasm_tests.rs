//! Unit tests for nietzsche-wasm (non-WASM target).
//!
...
//! To test Rust logic:    `cargo test -p nietzsche-wasm`

// Note: nietzsche-wasm compiles to cdylib+rlib. The rlib target allows
...
// ══════════════════════════════════════════════════════════════════════════════
// ID Mapping Logic (mirrors NietzscheDB's id_map / rev_map)
// ══════════════════════════════════════════════════════════════════════════════

/// Simulate the ID mapping layer from NietzscheDB
struct IdMapper {
...
fn global_config_default() {
    use nietzsche_core::GlobalConfig;
