...
impl Interceptor for AuthInterceptor {
    fn call(&mut self, mut request: Request<()>) -> Result<Request<()>, Status> {
        ...
        if let Some(uid) = &self.user_id {
            ...
            request.metadata_mut().insert("x-nietzsche-user-id", token);
        }
        Ok(request)
    }
}
...
impl Client {
    ...
    /// Connects to the `NietzscheDB` server.
    ///
    /// # Errors
    ...
    pub async fn create_collection(
        ...
        let req = nietzsche_proto::db::CreateCollectionRequest {
            name,
            dimension,
            metric,
        };
    ...
    pub async fn delete_collection(&mut self, name: String) -> Result<String, tonic::Status> {
        let req = nietzsche_proto::db::DeleteCollectionRequest { name };
    ...
    pub async fn list_collections(&mut self) -> Result<Vec<String>, tonic::Status> {
        let req = nietzsche_proto::db::Empty {};
    ...
    pub async fn get_collection_stats(
        &mut self,
        name: String,
    ) -> Result<nietzsche_proto::db::CollectionStatsResponse, tonic::Status> {
        let req = nietzsche_proto::db::CollectionStatsRequest { name };
    ...
    pub async fn rebuild_index(&mut self, name: String) -> Result<String, tonic::Status> {
        let req = nietzsche_proto::db::RebuildIndexRequest {
            name,
            filter_query: None,
        };
    ...
    pub async fn rebuild_index_with_filter(
        ...
        let req = nietzsche_proto::db::RebuildIndexRequest {
            name,
            filter_query: Some(nietzsche_proto::db::VacuumFilterQuery { key, op, value }),
        };
        let resp = self.inner.rebuild_index(req).await?;
        Ok(resp.into_inner().status)
    }
    ...
    pub async fn search_advanced(
        ...
        vector: Vec<f64>,
        top_k: u32,
        filters: Vec<nietzsche_proto::db::Filter>,
    ...
    pub async fn delete(
        ...
        let req = nietzsche_proto::db::DeleteRequest {
            id,
            collection: collection.unwrap_or_default(),
        };
    ...
    pub async fn configure(
        ...
        let req = nietzsche_proto::db::ConfigUpdate {
            ef_search,
            ef_construction,
            collection: collection.unwrap_or_default(),
        };
    ...
    pub async fn get_digest(
        &mut self,
        collection: Option<String>,
    ) -> Result<nietzsche_proto::db::DigestResponse, tonic::Status> {
        let req = nietzsche_proto::db::DigestRequest {
            collection: collection.unwrap_or_default(),
        };
