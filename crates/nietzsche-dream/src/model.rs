...
pub enum DreamEventType {
    ...
    Recurrence,
    /// A new DreamSnapshot node was generated by the neural dream generator.
    NeuralGeneration,
}
...
pub struct DreamSession {
    ...
    /// If neural dream generation was used, the UUID of the generated
    /// DreamSnapshot node. `None` if neural generation was disabled or failed.
    #[serde(default)]
    pub generated_node: Option<Uuid>,
}
